<?php
/**
 * Haritha Mothar: Color Patterns
 *
 * @package WordPress
 * @subpackage harithamothar
 * @since 1.0
 */
 ...
 */
function harithamothar_custom_colors_css() {
	...
	/**
	 * Filter Haritha Mothar default saturation level.
	 *
	 * @since Haritha Mothar 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */

	$saturation           = absint( apply_filters( 'harithamothar_custom_colors_saturation', 100 ) );
	$saturation           = $saturation . '%';

	$saturation_selection = absint( apply_filters( 'harithamothar_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	$lightness            = absint( apply_filters( 'harithamothar_custom_colors_lightness', 33 ) );
	$lightness            = $lightness . '%';

	$lightness_hover      = absint( apply_filters( 'harithamothar_custom_colors_lightness_hover', 23 ) );
	$lightness_hover      = $lightness_hover . '%';

	$lightness_selection  = absint( apply_filters( 'harithamothar_custom_colors_lightness_selection', 90 ) );
	...
	/**
	 * Filters Haritha Mothar custom colors CSS.
	 *
	 * @since Haritha Mothar 1.0
	 *
	 ...
	 */
	return apply_filters( 'harithamothar_custom_colors_css', $css, $primary_color, $saturation );
}
